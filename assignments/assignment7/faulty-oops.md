...
sp : ffffffc008dfbd20
x29: ffffffc008dfbd80 x28: ffffff8001b36a00 x27: 0000000000000000
x26: 0000000000000000 x25: 0000000000000000 x24: 0000000000000000
x23: 0000000000000012 x22: 0000000000000012 x21: ffffffc008dfbdc0
x20: 000000559130dcb0 x19: ffffff8001bd2400 x18: 0000000000000000
...
## Observation
We ca observe a NULL pointer reference error at address 0000000000000000 
`Unable to handle kernel NULL pointer dereference at virtual address 0000000000000000`
which then leads to the error ` faulty_write+0x10/0x20 [faulty]`

## Further Analysis
```
buildroot/output/host/aarch64-buildroot-linux-gnu/bin/objdump -S buildroot/output/target/lib/modules/6.1.44/extra/faulty.ko 
...
At address 14 we can see a write to register x1 which is containing the NULL address and hence causing this error